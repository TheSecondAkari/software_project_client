...
export default {
  ...
  methods: {
    getList() {
      ...
      // for (var i; i < this.addresslist.length; i++) {
      //   var templist = this.addresslist[i];
      //   this.list.push({
      //     id: templist.id,
      //     name: templist.name,
      //     tel: templist.phone,
    ...
    async onApply(Info) {
      console.log(Info);
      let data = await this.api.post("/addresses", {
        name: Info.name,
        phone: Info.tel,
    ...
    async onSave(Info) {
      let data = await this.api.put("/addresses/" + Info.id, {
        name: Info.name,
        phone: Info.tel,
        province: Info.province,
        city: Info.city,
    ...
    async onDelete(Info) {
      let data = await this.api.delete("/addresses/" + Info.id);
      if (data.status >= 200 && data.status < 300) {
        this.$notify({
          type: "success",
          message: data.data.errmsg
